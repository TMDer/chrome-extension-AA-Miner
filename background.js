...
(function() {
  ...
  var domain = AAMinerConfig.getAAMinerHost();
  ...
  chrome.cookies.getAll({domain: domain}, function(data) {
  ...
  chrome.runtime.onMessage.addListener(function(message, sender, sendResponse) {
    switch(message) {
      ...
      case "getUpdateAdUrl":
        sendResponse(AAMinerConfig.getUpdateAdUrl());
        break;

      case "getAAMinerUrl":
        var result = {
          loginUrl: AAMinerConfig.getLoginUrl(),
          logoutUrl: AAMinerConfig.getLogoutUrl()
        };
        sendResponse(result);
        break;
    }
